<?php global $user; ?>
<div class="container col-md-9 col-sm-12 rounded-0 d-flex justify-content-between" style="background-color: #fff8f9;">
    <div class="col-8 bg-white border rounded p-4 m-auto shadow-sm">
...
<style>
    ...
    .btn-primary:hover {
        background-color: linear-gradient(45deg, #d26287, #e47399);
