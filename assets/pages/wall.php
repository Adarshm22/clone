...
<style>
    ...
    .card, .modal-content, .input-group, .dropdown-menu, .modal-header {
        border: none;
        box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
        background-color: #fff8f9;
    }
    .card-title, .card-body, .input-group, .dropdown-menu, .modal-header, .modal-body {
        background-color: #fff8f9;
    }

    .btn-primary {
        color:white;
        background-color: linear-gradient(45deg, #e47399, #ff9a9e);
            border: none;
            border-radius: 5px;
    ...
    .comment-input, .form-control, .dropdown-item, .modal-title {
        color: #333;
    }
    ...
    .suggestion-item img, .user-info img {
        border-radius: 50%;
        border: 2px solid #fff;
    }
    .suggestion-item h6, .user-info h6 {
        margin: 0;
        font-size: 16px;
    }
    .suggestion-item p, .user-info p {
        margin: 0;
        font-size: 12px;
        color: #555;
    }
...
<div class="container col-md-10 col-sm-12 col-lg-9 rounded-0 d-flex justify-content-between" style="background-color:#fff8f9">
    <div class="post-container col-md-8 col-sm-12">
        ...
        ?>
        <div class="card mt-4">
            <div class="card-title d-flex justify-content-between align-items-center" style="background-color:#fff8f9">
            ...
            <img src="assets/images/posts/<?=$post['post_img']?>" loading=lazy class="card-img-top" alt="...">
            <div class="card-body" style="background-color:#fff8f9">
                ...
                <div class="input-group p-2 <?= $post['post_text'] ? 'border-top' : '' ?>">
                    ...
                    <button class="btn btn-primary rounded-0 border-0 add-comment " data-page='wall' data-cs="comment-section<?=$post['id']?>" data-post-id="<?=$post['id']?>" type="button" id="button-addon2">Post</button>
                </div>
            </div>
        </div>
    ...
    <!-- Suggestions Section -->
    <div class="col-lg-4 col-sm-0 overflow-hidden mt-4 suggestions-container" style="background-color:white;">
        <div class="user-info" style="background-color:#fff8f9;">
        ...
        <h6 class="text-muted p-2">Other Users</h6>
        <?php
        foreach ($follow_suggestions as $suser) {
        ?>
        <div class="suggestion-item" style="background-color:#fff8f9;">
