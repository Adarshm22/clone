...
//function for validate the login form
...
//function for getting userdata by id
...
//function for filtering the suggestion list
function filterFollowSuggestion(){
$list = getFollowSuggestions();
$filter_list  = array();
foreach($list as $user){
    if(count($filter_list)<5){
     $filter_list[]=$user;
    }
}
...
//function for getting users for follow suggestions
...
//functionfor getting userdata by username
...
return mysqli_query($db,$query);
    ...
    // function for validating add post form
